...
function validateConfig() {
    ...
    if (exports.config.features.enableEscrowPayments) {
        requiredVars.push('ESCROW_API_KEY', 'ESCROW_SECRET_KEY', 'ESCROW_MERCHANT_ID', 'ESCROW_WEBHOOK_SECRET');
    }
    ...
    if (!exports.config.currencies.supported.includes(exports.config.currencies.default)) {
        throw new Error(`Default currency ${exports.config.currencies.default} is not in supported currencies list`);
    }
    ...
    console.log(`🔒 Escrow payments: ${exports.config.features.enableEscrowPayments ? 'Enabled' : 'Disabled'}`);
}
...
exports.configUtils = {
    ...
    getWebhookUrls: () => ({
        ...
        escrow: exports.config.escrow.callbackUrl
    }),
