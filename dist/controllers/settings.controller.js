...
class SettingsController {
    ...
    async updateSettings(req, res, next) {
        try {
            ...
            const updatedSettings = await settingsService.updateSettings(parseInt(req.user.userId), updates, req);
            res.json({
                success: true,
    ...
    async changePassword(req, res, next) {
        try {
            ...
            const result = await settingsService.changePassword(parseInt(req.user.userId), { currentPassword, newPassword, confirmPassword }, req);
            res.json({
                success: true,
    ...
    async getVerificationStatus(req, res, next) {
        try {
            ...
            const verificationStatus = await settingsService.getVerificationStatus(parseInt(req.user.userId));
            res.json({
                success: true,
    ...
    async sendVerificationCode(req, res, next) {
        try {
            ...
            const result = await settingsService.sendVerificationCode(parseInt(req.user.userId), type, req);
    ...
    async verifyCode(req, res, next) {
        try {
            ...
            const result = await settingsService.verifyCode(parseInt(req.user.userId), type, code);
            res.json(result);
        }
        catch (error) {
            res.status(400).json({
    ...
    async getConnectedAccounts(req, res, next) {
        try {
            ...
            const connectedAccounts = await settingsService.getConnectedAccounts(parseInt(req.user.userId));
            res.json({
                success: true,
    ...
    async connectAccount(req, res, next) {
        try {
            ...
            const result = await settingsService.connectGoogleAccount(parseInt(req.user.userId), accessToken, email);
            res.json(result);
        }
        catch (error) {
            let statusCode = 400;
     ...
     */
    async disconnectAccountByProvider(req, res, next) {
        try {
            if (!req.user?.userId) {
                return res.status(401).json({
                    success: false,
            ...
            const result = await settingsService.disconnectAccountByProvider(parseInt(req.user.userId), provider);
            res.json(result);
        }
        catch (error) {
            res.status(400).json({
    ...
    async disconnectAccount(req, res, next) {
        try {
            ...
            const result = await settingsService.disconnectAccount(parseInt(req.user.userId), accountId);
            res.json(result);
        }
        catch (error) {
            res.status(400).json({
    ...
    async deactivateAccount(req, res, next) {
        try {
            ...
            const result = await settingsService.deactivateAccount(parseInt(req.user.userId), reason);
            res.json(result);
        }
        catch (error) {
            res.status(400).json({
    ...
    async deleteAccount(req, res, next) {
        try {
            ...
            const result = await settingsService.deleteAccount(parseInt(req.user.userId), password, reason);
     ...
     */
    async getSettingsSummary(req, res, next) {
        try {
            if (!req.user?.userId) {
                return res.status(401).json({
                    success: false,
