...
exports.logEscrowRequest = exports.escrowIpWhitelist = exports.sanitizeEscrowData = exports.validateEscrowWebhookSignature = exports.validateP2PEscrow = exports.validateEscrowTransfer = exports.validateEscrowWithdrawal = exports.validateEscrowDeposit = exports.rateLimitEscrowPayments = void 0;
const crypto_1 = __importDefault(require("crypto"));
const express_rate_limit_1 = __importDefault(require("express-rate-limit"));
// --- RATE LIMITING FOR ESCROW OPERATIONS ---
exports.rateLimitEscrowPayments = (0, express_rate_limit_1.default)({
...
const validateEscrowDeposit = (req, res, next) => {
    try {
        const data = req.body;
        const errors = [];
...
const validateEscrowWithdrawal = (req, res, next) => {
    try {
        const data = req.body;
        const errors = [];
        // Required fields validation
...
exports.validateEscrowWithdrawal = validateEscrowWithdrawal;
// --- ESCROW TRANSFER VALIDATION ---
const validateEscrowTransfer = (req, res, next) => {
    try {
        const data = req.body;
        const errors = [];
        // Required fields validation
...
exports.validateEscrowTransfer = validateEscrowTransfer;
// --- P2P ESCROW VALIDATION ---
const validateP2PEscrow = (req, res, next) => {
    try {
        const data = req.body;
        const errors = [];
        // Required fields validation
...
exports.validateP2PEscrow = validateP2PEscrow;
// --- ESCROW WEBHOOK SIGNATURE VALIDATION ---
const validateEscrowWebhookSignature = (req, res, next) => {
    try {
...
exports.validateEscrowWebhookSignature = validateEscrowWebhookSignature;
// --- ESCROW TERMS VALIDATION HELPER ---
function validateEscrowTerms(terms) {
    const errors = [];
    if (!terms.type) {
    ...
    if (terms.milestones && Array.isArray(terms.milestones)) {
        ...
        terms.milestones.forEach((milestone, index) => {
...
const sanitizeEscrowData = (req, res, next) => {
    try {
...
exports.sanitizeEscrowData = sanitizeEscrowData;
// --- ESCROW IP WHITELIST MIDDLEWARE ---
const escrowIpWhitelist = (req, res, next) => {
...
exports.escrowIpWhitelist = escrowIpWhitelist;
// --- ESCROW REQUEST LOGGING MIDDLEWARE ---
const logEscrowRequest = (req, res, next) => {
...
exports.logEscrowRequest = logEscrowRequest;
