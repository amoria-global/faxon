...
exports.validateTransactionId = exports.logEscrowRequest = exports.sanitizeEscrowData = exports.ipWhitelist = exports.validatePesapalWebhook = exports.validateRelease = exports.validateRefund = exports.validateWithdrawal = exports.validateDeposit = exports.rateLimitWebhooks = exports.rateLimitEscrowOperations = void 0;
const crypto_1 = __importDefault(require("crypto"));
const express_rate_limit_1 = __importDefault(require("express-rate-limit"));
// === RATE LIMITING ===
exports.rateLimitEscrowOperations = (0, express_rate_limit_1.default)({
...
exports.rateLimitWebhooks = (0, express_rate_limit_1.default)({
...
// === WEBHOOK SECURITY ===
const validatePesapalWebhook = (req, res, next) => {
    try {
...
exports.validatePesapalWebhook = validatePesapalWebhook;
// === IP WHITELISTING ===
...
// === HELPER FUNCTIONS ===
function validateSplitRules(rules) {
    const errors = [];
...
function validateDestination(destination, method) {
    const errors = [];
    ...
    if (method === 'MOBILE') {
        ...
        if (destination.mobileProvider) {
            const validProviders = ['MTN', 'AIRTEL', 'TIGO', 'RWANDATEL'];
