...
const validateAgentAsHost = (req, res, next) => {
    if (!req.user) {
        res.status(401).json({
            success: false,
            message: 'Authentication required'
...
exports.validateAgentAsHost = validateAgentAsHost;
