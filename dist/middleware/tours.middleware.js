...
exports.validateReviewPermissions = exports.validateGuest = exports.validateScheduleAccess = exports.validateTourUpdatePermissions = exports.cacheMiddleware = exports.rateLimitExpensiveOperations = exports.validateBulkOperation = exports.validateBookingAccess = exports.validateTourImageUpload = exports.validateTourSchedule = exports.validateTourBookingUpdate = exports.validateTourBooking = exports.validateTourGuideAccess = exports.validateAdmin = exports.validateTourGuide = exports.validateTour = void 0;
...
const validateTour = (req, res, next) => {
    ...
    // Validate difficulty
    if (data.difficulty) {
        const validDifficulties = ['easy', 'moderate', 'challenging', 'extreme'];
...
const validateTourGuideAccess = async (req, res, next) => {
    try {
        if (!req.user) {
            res.status(401).json({
                success: false,
...
exports.validateTourGuideAccess = validateTourGuideAccess;
...
const validateTourBookingUpdate = (req, res, next) => {
    const data = req.body;
    const errors = [];
    // Validate status if provided
    if (data.status) {
        const validStatuses = ['pending', 'confirmed', 'in_progress', 'completed', 'cancelled', 'refunded', 'no_show'];
...
exports.validateTourBookingUpdate = validateTourBookingUpdate;
// Validate tour schedule creation/update
const validateTourSchedule = (req, res, next) => {
    const data = req.body;
    const errors = [];
...
exports.validateTourSchedule = validateTourSchedule;
// Validate image upload data
const validateTourImageUpload = (req, res, next) => {
...
exports.validateTourImageUpload = validateTourImageUpload;
...
const validateTourUpdatePermissions = (req, res, next) => {
...
exports.validateTourUpdatePermissions = validateTourUpdatePermissions;
// Validate tour schedule access
const validateScheduleAccess = async (req, res, next) => {
    try {
        if (!req.user) {
            res.status(401).json({
                success: false,
...
exports.validateScheduleAccess = validateScheduleAccess;
...
const validateReviewPermissions = async (req, res, next) => {
    try {
        if (!req.user) {
            res.status(401).json({
                success: false,
...
exports.validateReviewPermissions = validateReviewPermissions;
