...
exports.BrevoPropertyMailingService = void 0;
// src/services/brevo.property.ts
const axios_1 = __importDefault(require("axios"));
const config_1 = require("../config/config");
// --- PROPERTY MAILING SERVICE CLASS ---
class BrevoPropertyMailingService {
    constructor() {
     ...
     */
    async sendPropertySubmissionEmail(context) {
        const emailData = {
     ...
     */
    async sendPropertyStatusUpdateEmail(context) {
        const subjectMap = {
    ...
    getBaseTemplate() {
        // This contains the full, corrected CSS from the previous step.
        return `
      <style>
    ...
    getPropertySubmissionTemplate(context) {
    ...
    getPropertyStatusUpdateTemplate(context) {
    ...
    getPropertySubmissionTextTemplate(context) {
        return `
    ...
    getPropertyStatusUpdateTextTemplate(context) {
...
exports.BrevoPropertyMailingService = BrevoPropertyMailingService;
