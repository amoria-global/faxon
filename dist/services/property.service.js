...
class PropertyService {
    ...
    async transformToPropertyInfo(property) {
        ...
        return {
            ...
            features: property.features ? JSON.parse(property.features) : [], // Fix: safely parse with type assertion and fallback
            description: property.description,
            images: property.images ? JSON.parse(property.images) : {}, // Fix: safely parse with type assertion and fallback
    ...
    transformToPropertyReview(review) {
        return {
            ...
            images: review.images ? JSON.parse(review.images) : undefined, // Fix: safely parse with type assertion
