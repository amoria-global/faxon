...
class AuthService {
    constructor() {
        this.brevoService = new brevo_auth_1.BrevoMailingService();
    }
    ...
    async updateUserProfile(userId, data, req) {
        ...
        if (data.bio !== undefined)
            tourGuideData.bio = data.bio;
        if (data.experience !== undefined)
            tourGuideData.experience = data.experience;
        ...
        if (data.licenseNumber !== undefined)
            tourGuideData.licenseNumber = data.licenseNumber;
    ...
    async adminUpdateUser(userId, data) {
        ...
        if (data.languages !== undefined) {
            updateData.languages = data.languages ? JSON.stringify(data.languages) : client_1.Prisma.DbNull;
        }
        if (data.specializations !== undefined) {
            updateData.specializations = data.specializations ? JSON.stringify(data.specializations) : client_1.Prisma.DbNull;
        }
        if (data.licenseNumber !== undefined)
            updateData.licenseNumber = data.licenseNumber;
        if (data.certifications !== undefined) {
            updateData.certifications = data.certifications ? JSON.stringify(data.certifications) : client_1.Prisma.DbNull;
        }
        const updatedUser = await prisma.user.update({
            where: { id: userId },
            data: updateData
