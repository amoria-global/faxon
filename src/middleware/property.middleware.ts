...
import { CreatePropertyDto, PropertyImages } from '../types/property.types';
  ...
  try {
    ...
    if (!data.images) {
      ...
      imageCategories.forEach(category => {
        const categoryImages = data.images[category as keyof PropertyImages];
...
export const validatePropertyUpdate = (req: AuthenticatedRequest, res: Response, next: NextFunction): void => {
  try {
    const data = req.body;
    const errors: string[] = [];
...
export const validateBooking = (req: AuthenticatedRequest, res: Response, next: NextFunction): void => {
  try {
    const data = req.body;
    const errors: string[] = [];
...
export const validateReview = (req: AuthenticatedRequest, res: Response, next: NextFunction): void => {
  try {
    const data = req.body;
    const errors: string[] = [];
