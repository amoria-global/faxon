//src/middleware/booking.validation.ts
import { Request, Response, NextFunction } from 'express';
import { CreateBookingDto, PaymentMethod } from '../types/booking.types';
  ...
  try {
    ...
    if (data.paymentTiming === 'now') {
      if (!data.paymentMethod) {
        ...
        const validMethods: PaymentMethod[] = ['card', 'momo', 'airtel', 'mpesa', 'property'];
...
export const validateBookingCancellation = (req: AuthenticatedRequest, res: Response, next: NextFunction): void => {
  try {
